                        ...
                        <Nav className="me-auto">
                            {!auth ? (
                                ...
                                <>
                                    ...
                                    <Nav.Link as={Link} to="/staff/requests">Borrow Requests</Nav.Link>
                                    <Nav.Link as={Link} to="/staff/search-pro">Search Pro</Nav.Link>
                                    
                                    <Nav.Link as={Link} to="/staff/book-status">Book Status</Nav.Link>
                                    <Nav.Link onClick={handleLogout}>Logout</Nav.Link>
                                </>
                            ) : (
                                <>
